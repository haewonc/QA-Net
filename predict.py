...
config = Config()
mod = Model(config)
mod.load_checkpoint("results/saved_models/model_final.pt")
test_list = getImageSetDirectories("../probav_data/test/")
test = ImagesetDataset(imset_dir=test_list, patch_size=128, top_k=None)
